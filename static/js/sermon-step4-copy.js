...
async function assembleGptProDraft() {
  ...
  draft += `[대지(본론) 작성 지침] ★★★\n`;
  draft += `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`;
  draft += `각 대지는 풍성하게 작성하세요. 짧은 대지는 설교를 빈약하게 만듭니다.\n\n`;
  draft += `✗ 짧은 대지 (금지):\n`;
  draft += `  "믿음은 떠남입니다. 아브라함은 떠났습니다. 우리도 떠나야 합니다."\n\n`;
  draft += `✓ 풍성한 대지 (권장) - 각 대지에 5가지 요소 포함:\n`;
  draft += `  ① 도입: 이 대지에서 다룰 핵심 질문이나 주제 제시 (2-3문장)\n`;
  draft += `  ② 본문 해설: 성경 구절의 의미를 스토리텔링으로 설명 (5-8문장)\n`;
  draft += `  ③ 예화: 구체적인 인물, 상황, 감정이 담긴 이야기 (5-8문장)\n`;
  draft += `  ④ 적용: "이번 주에 이렇게 해보세요" 실천 가능한 제안 (3-5문장)\n`;
  draft += `  ⑤ 전환: 다음 대지로 자연스럽게 연결 (1-2문장)\n\n`;
  draft += `각 대지에 최소 15-20문장 이상 작성하세요!\n`;
  draft += `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n`;
