...
- 문체는 '강연형 설교' 스타일로, 자연스럽고 대화하듯이, 그러나 가볍지 않게 작성합니다.`,
      ...
      writing_style: {
        label: "★★★ 문단/줄바꿈 스타일 (최우선 준수사항) ★★★",
        description: "이 규칙을 어기면 설교문이 17쪽 이상으로 늘어나 사용할 수 없게 됩니다. 반드시 지키세요.",

        core_principle: "설교문은 '문단 단위'로 작성합니다. 한 문단 안에 3~5개 문장을 공백 없이 연속으로 이어 씁니다.",

        must_do: [
          "한 문단에 3~5개 문장을 한 줄에 이어서 작성 (문장 사이에 줄바꿈 금지)",
          "문단이 끝날 때만 빈 줄 1개 삽입",
          "섹션 제목([서론], [1대지] 등) 앞뒤에만 줄바꿈"
        ],

        must_not: [
          "절대 금지: 문장이 끝날 때마다 줄바꿈(Enter) 누르기",
          "절대 금지: 질문형 문장을 별도 줄로 분리하기",
          "절대 금지: 강조하고 싶은 문장을 혼자 한 줄에 배치하기",
          "절대 금지: 짧은 문장들을 한 줄씩 나열하기"
        ],

        bad_example: "여러분, 혹시 이런 생각해 본 적 있나요?\\n누구는 시험 기간일 수도 있고,\\n누구는 친구 관계 때문에 복잡할 수도 있다.\\n혹시 이런 생각 해본 적 없니?\\n\"하나님 믿으면 잘 되게 해주신다면서요?\"",

        good_example: "여러분, 혹시 이런 생각해 본 적 있나요? 누구는 시험 기간일 수도 있고, 누구는 친구 관계 때문에 마음이 복잡할 수도 있고, 또 어떤 친구는 집안 사정 때문에 말 못 할 고민을 가지고 있을 수도 있다. 혹시 이런 생각 해본 적 없니? \"하나님 믿으면 잘 되게 해주신다면서요? 근데 왜 저는 자꾸 어렵죠?\"\\n\\n이스라엘 백성도 그랬다. 애굽에서 종살이에서 벗어나 약속의 땅으로 가는 길에, 하나님은 그냥 바로 가게 하지 않으시고 40년 동안 광야 학교에 머물게 하셨다.",

        critical_warning: "bad_example 형식으로 작성하면 출력물을 사용할 수 없습니다. 반드시 good_example 형식을 따르세요. 문장 끝에서 절대 줄바꿈하지 마세요."
      },
