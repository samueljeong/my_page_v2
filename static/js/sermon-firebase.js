...
- 모든 설명은 가능한 한 관찰과 해석에 머무르고, '~해야 한다'식의 적용 문장은 피합니다.`,
    ...
    "step2": {
      ...
      "output_format": {
        "설교_제목": {
          "label": "설교 제목",
          "description": "본문의 핵심 메시지를 반영한 제목"
        },
        "서론_방향": {
          "label": "서론 방향",
          "description": "청중의 관심을 끌고 본문으로 이끄는 도입 방향 2-3문장"
        },
        "대지_1": {
          "label": "대지 1",
          "description": "첫 번째 핵심 포인트",
          "sub_items": {
            "소제목": "대지 제목",
            "본문_근거": "절 번호",
            "핵심_내용": "Step1 해설 기반 정리 3-4문장",
            "전개_방향": "설명-예증-적용의 방향성"
          }
        },
        "대지_2": {
          "label": "대지 2",
          "description": "두 번째 핵심 포인트",
          "sub_items": {
            "소제목": "대지 제목",
            "본문_근거": "절 번호",
            "핵심_내용": "Step1 해설 기반 정리 3-4문장",
        ...
        "결론_방향": {
          "label": "결론 방향",
          "description": "3대지를 종합하고 삶의 적용으로 마무리하는 방향 2-3문장"
        },
        "대지_연결_흐름": {
          "label": "대지 연결 흐름",
          "description": "3개 대지가 어떻게 유기적으로 연결되는지 2-3문장"
        }
      },
      "constraints": {
        "no_new_interpretation": "Step1에 없는 새로운 해석 추가 금지",
        "balanced_points": "세 대지는 분량과 논리 비중이 균형 있게",
        "from_step1_candidates": "대지는 반드시 Step1의 대지_후보에서 선택"
      }
    },
    "step3": {
      "style": "3대지",
