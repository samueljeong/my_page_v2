...
════════════════════════════════════════
1. [OPEN] 오프닝 (5%)
   - ★ 질문 형식으로 시작: "왜 이런 일이 벌어졌을까?", "무엇이 이들을 움직였을까?"
   - 흥미로운 장면을 빠르게 전환하며 집중도를 높임
   - 이 에피소드에서 다룰 내용 예고
   - 감정적 표현 없이 사실 중심

2. [BODY] 본문 (75%)
   - 수집된 자료의 내용을 스토리로 풀어서 설명
   - ★ 긴장-이완 페이싱: 위기/갈등 장면과 설명 장면을 적절히 배치
   - ★ 짧은 씬으로 집중도 유지 (한 씬에 너무 많은 내용 금지)
   - 시간순 또는 논리적 순서로 전개
   - 중간중간 시청자의 이해를 돕는 설명 추가
   - ★ 역사적 갈등, 위기, 대립 구도로 긴장감 조성
   - ⚠️ 자료에 없는 내용 추가 금지
...
4. [ENDING] 마무리 (10%)
   - ★ 생각할 거리를 던지며 여운 남기기: "과연 그들의 선택은 옳았을까?", "이 사건이 없었다면 역사는 어떻게 달라졌을까?"
   - 핵심 내용 간단 정리 (3줄 이내)
   - 다음 에피소드 예고
